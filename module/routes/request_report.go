...
type RequestReportRouteResponse struct {
	Status string              `json:"status"`
	Data   *types.ModuleReport `json:"data"`
	Error  *string             `json:"error"`
}

func RequestReportRoute(c echo.Context) error {
	...
	module_report, err := controllers.RequestReportController(&app_context, serial_number)
	if err != nil {
		err := err.Error()
