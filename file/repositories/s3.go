...
func (sr *S3Repository) UploadFile(id string, file_header *multipart.FileHeader) error {
...
func (sr *S3Repository) GetFile(id string, extension string) (read_url string, err error) {
...
func (sr *S3Repository) DeleteFile(id string) error {
	ctx := context.Background()
